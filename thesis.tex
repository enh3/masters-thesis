...
\begin{figure}[h]
    \centering
    \subfigure{
        \includegraphics[scale=0.25]{DSC00117_3}
    }
    \subfigure{
        \includegraphics[scale=0.07]{pigeons}
    }
...
\customincludegraphics[scale=0.7]{2024-04-28_MH}{fig:live}{The artist during concert preparations for the first performance of \textit{Élégies}}
