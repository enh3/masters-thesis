...
\hypersetup{
  ...
  pdfsubject = {Developing a hyper-instrument interface for the pipe organ of \textit{l’église Saint-Édouard}},
...
L'instrument examiné dans ce travail est l'orgue symphonique de \textit{l’église Saint-Édouard} où l'auteur est organiste. 
...
The instrument examined in this work is the symphonic organ of \textit{l’église Saint-Édouard} where the author is organist. 
...
To \textit{l’église Saint-Édouard}, both the church and the community, for being my home during the last two years. I have learned so much.
...
More specifically, this project celebrates the rich heritage of the Casavant Frères symphonic pipe organ at \textit{l’église Saint-Édouard} in Montréal, where I have been organist since July 2022. 
...
The church space is also considered in its entirety, through spatialisation of sound diffusion, as well as the use of sonic iconography from throughout \textit{l’église Saint-Édouard}.}
...
In my case, the organ of \textit{l’église Saint-Édouard} is a 1913 Casavant Frères work in the symphonic tradition. 
...
Furthermore, the organ of \textit{l’église Saint-Édouard} has a unique and interesting history. 
...
We could say that there is a link in interface, and a link in shared space, and that would be enough, but I wanted to go further and emulate the sound of the pipe-organ, based on analyses of the pipe organ of \textit{l’église Saint-Édouard}, not with the goal of simple reproduction, but with the end of manipulating, transforming, and mutating these emulations in ways that would be impossible for the traditional instrument, in the hopes of achieving a dialectic, or a sort of continuum of acoustic and synthetic, which interact, overlap, disagree, and sometimes fuse.
...
Though this speaker is less flexible and not directly integrated with the others, it was important to me to highlight the unique heritage of the organ of \textit{l’église Saint-Édouard}, which was originally installed in the west gallery before being dismantled and relocated to the north transept in the 1950s}\footcite{noauthor_eglise_nodate}. 
...
\customincludegraphics[scale=0.5]{stageplot_ste-edouard.png}{A view of \textit{l’église Saint-Édouard} from above, showing the microphone and five speaker diffusion layout in relation to the organ console and the organ itself.}
...
The more time I spent in \textit{l’église Saint-Édouard} and the more I considered it's heritage and all of the shared memory inside and outside of it's walls, the more it felt compelling to integrate a non-live component.
...
The other sense in which I attempt to embody the richness of \textit{l’église Saint-Édouard} is through the use of prerecorded audio, and in particular through what I call \textit{le chemin}, a reference to \textit{le chemin de croix}, or in english, the stations of the cross. 
...
During my master's program, in addition to being organist, I also became caretaker at \textit{l’église Saint-Édouard}, allowing me access to the many areas of the church that would not be otherwise accessible. 
...
On the one hand, a recording of me walking down Beaubien from my apartment to \textit{l’église Saint-Édouard} during the summer rain storms of July 2023. 
This is \hl{layered with another} recording that I downloaded from the YouTube channel \hl{\textit{Saint-Edouard de Montréal}} of the bells of \textit{l’église Saint-Édouard}\footcite{saint-edouard_de_montreal_volee_2022}. 
...
The church is a contained unit, which is often heavily sonically isolated from environmental sound, especially with stone constructions like \textit{l’église Saint-Édouard}. 
...
The third station takes place in \textit{la salle Morin}, a hall that is very frequently rented for events, and is named after the first priest of \textit{l’église Saint-Édouard} Joseph-Napoléon Morin in 1895. 
...
\customincludegraphics[scale=0.05]{candles.JPG}{The ever burning candles of \textit{l’église Saint-Édouard} flicker in the darkness.}%%Station 5
...
\begin{figure}[h]
    ...
    \caption{The stairwell leading to the organ loft on the left, and the pigeons of \textit{l’église Saint-Édouard} nestled into the church's stone walls on the right.}
    \label{fig:sidebyside}
\end{figure}
...
While preparing for the concert, I suddenly reflected on the first time I had ever seen \textit{l’église Saint-Édouard}. 
...
In the summer of 2023\hl{,} I created a custom .organ file for GrandOrgue based on the Burea Church organ, which was made to mimick the both the layout of the stops of the organ at \textit{l’église Saint-Édouard}, as well as the corresponding stop sounds as close as possible. 
...
Eventually, it would be wonderful to sample the stops at \textit{l’église Saint-Édouard} and create a virtual organ representing this space, but for the purposes of creating MIDI mockups, this was already leagues ahead of MuseScore's built in sounds. 
...
This melodic fragment is adapted from a session of singing the poetry of Rilke in \textit{l’église Saint-Édouard} in the fall of 2022\footnote{This was a solo session where I paced throughout the dimly lit church while searching for melodic material in the text. I recorded these experiments on my Zoom H4N and later sifted through them for the most compelling moments.}, and is developed throughout the rest of the piece.
...
Ultimately, I decided to change the opening dynamic to pianissimo, using the dulciane stop, which on the organ at \textit{l’église Saint-Édouard} is extremely soft.
...
This section uses the cantus firmus as middle voice in a three voice texture, where the bassline is taken by the left hand on the \textit{Grand Orgue} division and the treble by the right hand on the MIDI keyboard.
...
As for the composition of the descending motive, the first four measures came to me around the same time as the rising motive, around September, 2022, when I first started as organist at \textit{l’église Saint-Édouard} and started my masters program at l'Université de Montréal.  
...
The arpeggiations also form, both visually in the score, and sonically, a set of arches, symbolizing of the arches and spires of \textit{l’église Saint-Édouard}.
...
The sound world is based in F minor, which refers to the minor triad contained in the harmonics of the spectral analysis of the lowest bell of \textit{l’église Saint-Édouard}, and fragmented bursts of sound are heard interspersed with the clicking of the transient sounds.
...
This was not planned in any meaningful way at the time, but in retrospect, it is an appropriate choice, as the spectral analysis of the bells of \textit{l’église Saint-Édouard} reveal a duality of F major and F minor.
...
The movement begins with soft chords played on the \textit{Récit}, echoing the parallel stack of fifths heard at the end of the first movement. 
However, after the third iteration, the chords diverge from the original fifths, transitioning into a series of major7 and minor7 chords, mainly in drop \hl{2/4} voicings. 
...
Following this, the pedal enters with an imposing sound, combining the 32' and 16' flutes with a bright plein orgue registration from the \textit{Grand Orgue}. 
...
This section ends with a \hl{6--5} sequence followed by a final, reharmonized version of the initial theme firs heard in the voice in the first movement. 
