...
\customincludegraphics[scale=0.25]{palacio-quintin_mappings.png}{Cléo Palacio-Quintin's graphic demonstrating the important distincion between convergent and divergent mappings, using the flute as an example}
