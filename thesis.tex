...
As of December, 2024, it has been performed three times in its entirety this year, on April 26\textsuperscript{th} and 28{th}\footnote{The video file elegies\_audio.wav accompanying this thesis represents the April 28\textsuperscript{th} performance, while the file elegies\_audio.mp4 splices in several moments from the April 26\textsuperscript{th} performance that were more successful.}, and again on September 7\textsuperscript{th}.
...
\begin{itemize}
    ...
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_elegies\_score.pdf}
    \par Score for \textit{Élégies}.
    
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_elegies\_audio.wav}
    \par Edited audio combining April 26\textsuperscript{th}, 2024 and April \textsuperscript{28}, 2024 performances of Élégies.
    
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_elegies\_video.mp4}
    \par Video from April 28\textsuperscript{th}, 2024 performance of \textit{Élégies}.
    
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_synthesis\_demo.mp4}
    ...
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_effects\_demo.mp4}
    ...
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_jardin\_de\_givre\_score.pdf}
    \par Score for \textit{Jardin de givre.}
    
    \item \hangindent=2em \textbf{Sidloski\_Kjel\_2025\_jardin\_de\_givre\_video.mp4}
