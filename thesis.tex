...
\begin{figure}[h]
	...
	\caption{Analysis of the note C in every octave of the bourdon 8' of the \textit{récit} division using Sonic Visualiser. White numbers represent the number of harmonics present in a note, a red number represents a particularily strong harmonic, and a blue number a weak one.}
...
This movement introduces a new theme, chromatic and winding, which seemed to naturally fit the cadence and affective themes in the poetic fragment.
...
Contemporary music and musical interfaces face the issue of perenity, with many projects serving the means of a given context, only to fall to disuse and abandon. 
